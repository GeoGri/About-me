...
var sections = ['home', 'about', 'resume','portfolio', 'contact'];
...
function sendMail(){
	var link = "mailto:grzegorz1wojda@gmail.com?"
			 + "&subject="	 + escape("GET IN TOUCH - PORTFOLIO SITE")
			 + "&body=Name:" + escape(document.getElementById('name').value)
